export default function weatherDataCall (location) {
    ...
    fetch(`https://api.open-meteo.com/v1/forecast?latitude=${locationCoords(location).lat}&longitude=${locationCoords(location).long}&daily=weathercode,temperature_2m_max,temperature_2m_min,rain_sum,snowfall_sum&past_days=14&timezone=America%2FLos_Angeles`)
