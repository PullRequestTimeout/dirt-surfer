        ...
        return trailData.map((trail, index) => {
            return (
                <TrailCard
                    ...
                    starRating={forecastData.find(({ trailName }) => trailName === `${trail.trailName}`).starRating}
                    description={trail.description}
                    descriptiveForecast={forecastData.find(({ trailName }) => trailName === `${trail.trailName}`).descriptiveForecast}
                />
            )
        })
    } else {
